...
# Load the arrow icon
arrow_icon = ctk.CTkImage(light_image=Image.open("arrow-circle-left.png"), size=(30, 30))
...
# Right Frame (Image and Supplier Info)
upload_label = ctk.CTkLabel(right_frame, text="Upload File", text_color="black",
                            font=ctk.CTkFont("Lexend", 16, weight="bold"))
upload_label.grid(row=0, column=0, padx=(10, 0), pady=(15, 4), sticky="w")

image_frame = ctk.CTkFrame(right_frame, height=150, width=280, corner_radius=8,
                           fg_color="#E8E8E8", border_width=2, border_color="black")
image_frame.grid(row=1, column=0, sticky="ew", pady=(0, 8), padx=(10, 0))
image_frame.grid_propagate(False)

image_label = ctk.CTkLabel(image_frame, text="🍯\nVinegar Bottle",
                           font=ctk.CTkFont("Lexend", 18), text_color="#666666")
image_label.place(relx=0.5, rely=0.5, anchor="center")

# Supplier info
create_readonly_entry(right_frame, 3, "Supplier", "NutriAsia")
create_readonly_entry(right_frame, 5, "Contact Person", "Kim Mingyu")
create_readonly_entry(right_frame, 7, "Contact Number", "09230492304")
create_readonly_entry(right_frame, 9, "Email", "kimmingyu@gmail.com")
